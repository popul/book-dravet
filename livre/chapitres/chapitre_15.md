...
```mermaid
graph TD
    A["Situation<br/>critique"] --> B{"Expression<br/>de volonté ?"}
    B -->|Oui| C["Recueillir<br/>son choix"]
    B -->|Non| D{"Directives<br/>anticipées ?"}
    D -->|Oui| E["Appliquer les<br/>directives"]
    D -->|Non| F{"Personne de<br/>confiance ?"}
    F -->|Oui| G["Consulter la<br/>personne"]
    F -->|Non| H["Consulter<br/>famille/tuteur"]
    C --> I["Procédure<br/>collégiale"]
    E --> I
    G --> I
    H --> I
    I --> J{"Proportionnalité ?"}
    J -->|Proportionné| K["Soins actifs"]
    J -->|Déraisonnable| L["Limitation +<br/>Confort"]
