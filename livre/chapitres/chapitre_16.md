...
```mermaid
graph TD
    subgraph "Préclinique"
    A["CRISPRa"] -->|"Colasante 2020"| B("Modèles murins")
    end

    subgraph "Essais cliniques"
    D["STK-001<br/>(ASO TANGO)"] --> E("Phase 1/2a<br/>MONARCH")
    E --> F("Phase 2<br/>SWALLOWTAIL")
    G["ETX101<br/>(AAV9)"] --> H("Phase 1/2<br/>EMBRAVE")
    end

    subgraph "Horizon 2029-2031"
    F --> I["Approbation<br/>potentielle"]
    H --> I
    end
