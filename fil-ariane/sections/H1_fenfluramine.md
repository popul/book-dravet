...
graph TD
    ...
    B -->|Non| C[En parler<br/>au neurologue]
    B -->|Oui| D[Initier le<br/>traitement]
    C --> E{Neurologue<br/>favorable ?}
    E -->|Oui| D
    E -->|Non ou hesitant| F[Consulter<br/>le CReER]
    F --> D
    D --> G[Echocardiographie<br/>avant debut]
    G --> H[Debut fenfluramine<br/>dose progressive]
    H --> I[Evaluation<br/>a 3-4 mois]
    I --> J{Reponse<br/>clinique ?}
    J -->|Oui| K[Poursuivre<br/>echo tous les 6 mois]
