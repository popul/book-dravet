...
```mermaid
graph TD
    A[Douleur chronique<br/>non identifiee] --> B[Stress physiologique<br/>inflammation]
    B --> C[Seuil epileptogene<br/>abaisse]
    C --> D[Augmentation<br/>des crises]
    D --> E[Augmentation<br/>des medicaments]
    E --> F[Effets secondaires<br/>constipation, os]
    F --> A
    G[Identifier et<br/>traiter la douleur] --> H[Briser<br/>le cercle]
    H --> I[Moins de stress<br/>moins de crises]
```
