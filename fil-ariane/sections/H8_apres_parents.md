...
```mermaid
graph TD
    A[Protection<br/>juridique] --> B[Mandat de<br/>protection future]
    A --> C[Habilitation<br/>familiale]
    A --> D[Tutelle /<br/>Curatelle]
    B --> E[Chez le notaire<br/>forme authentique]
    C --> F[Demande au<br/>juge des tutelles]
    D --> G[Transfert vers<br/>fratrie]
    D --> H[Transfert vers<br/>mandataire pro]
    D --> I[Dissociation<br/>personne / patrimoine]
```
