...
```mermaid
graph TD
    A[Zorevunersen<br/>STK-001] --> B[Phase 3<br/>2025]
    B --> C[Potentielle AMM<br/>2027-2028 ?]
    D[ETX101<br/>Therapie genique] --> E[Phase 1/2<br/>en cours]
    E --> F[Phase 3<br/>a definir]
    F --> G[Potentielle AMM<br/>2029+ ?]
    H[Autres pistes] --> I[CRISPR/dCas9<br/>recherche fondamentale]
    H --> J[Ataluren<br/>preclinique]
    H --> K[Clemizole<br/>preclinique]
```
